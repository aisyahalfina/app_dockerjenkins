...
import { View, DrawerLayoutAndroid, StatusBar, Text } from "react-native";
...
const App = () => {
  ...
  const navigationView = () => (
    ...
    >
      ...
      {/* Bagian bawah: footer nama */}
      <Text style={{ color: "#aaa", textAlign: "center" }}>By: Aisyah Alfina Putri 🤗</Text>
    </View>
  );
